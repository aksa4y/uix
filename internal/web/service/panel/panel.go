...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/aksa4y/ui/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/aksa4y/3x-ui/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/aksa4y/3x-ui/releases/tags/" + tag
	}
